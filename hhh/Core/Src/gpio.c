...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, B2_Pin|C1_Pin|C2_Pin|D1_Pin
                          |D2_Pin|A2_Pin|B1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PEPin PEPin PEPin PEPin
                           PEPin PEPin PEPin */
  GPIO_InitStruct.Pin = B2_Pin|C1_Pin|C2_Pin|D1_Pin
                          |D2_Pin|A2_Pin|B1_Pin;
