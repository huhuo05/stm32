...
void MG513_Motor_stop(void)
{
    ...
    HAL_GPIO_WritePin(A1_GPIO_Port, A2_Pin, GPIO_PIN_RESET);
    // B
    HAL_GPIO_WritePin(B1_GPIO_Port, B1_Pin, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(B1_GPIO_Port, B2_Pin, GPIO_PIN_RESET);
    // C
    HAL_GPIO_WritePin(C1_GPIO_Port, C1_Pin, GPIO_PIN_RESET);
    HAL_GPIO_WritePin(C1_GPIO_Port, C2_Pin, GPIO_PIN_RESET);
    // D
